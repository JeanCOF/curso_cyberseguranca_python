...
class Conta_bancaria:
    def __init__(self, titular, saldo_inicial):
        ...
        self.saldo_inicial = saldo_inicial  # Agora o saldo é inicializado corretamente
    
    def informacoes(self):
        print("Conta: Sr/Sra {}, seu saldo atual é de R${}".format(self.titular, self.saldo_inicial))

    def depositar(self, valor):  # Agora o método recebe o valor a ser depositado
    ...
    def sacar(self, valor):  # Agora o método recebe o valor a ser sacado
